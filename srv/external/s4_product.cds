/* checksum : 99a98d8c298f56767e6078cf6c221bb9 */
@cds.external : true
...
entity s4_product.A_Product {
  ...
  to_Description : Association to many s4_product.A_ProductDescription {  };
  @cds.ambiguous : 'missing on condition?'
  to_Plant : Association to many s4_product.A_ProductPlant {  };
  @cds.ambiguous : 'missing on condition?'
  to_ProductBasicText : Association to many s4_product.A_ProductBasicText {  };
  @cds.ambiguous : 'missing on condition?'
  to_ProductInspectionText : Association to many s4_product.A_ProductInspectionText {  };
  @cds.ambiguous : 'missing on condition?'
  to_ProductProcurement : Association to s4_product.A_ProductProcurement {  };
  @cds.ambiguous : 'missing on condition?'
  to_ProductPurchaseText : Association to many s4_product.A_ProductPurchaseText {  };
  @cds.ambiguous : 'missing on condition?'
  to_ProductQualityMgmt : Association to s4_product.A_ProductQualityMgmt {  };
  @cds.ambiguous : 'missing on condition?'
  to_ProductSales : Association to s4_product.A_ProductSales {  };
  @cds.ambiguous : 'missing on condition?'
  to_ProductSalesTax : Association to many s4_product.A_ProductSalesTax {  };
  @cds.ambiguous : 'missing on condition?'
  to_ProductStorage : Association to s4_product.A_ProductStorage {  };
  @cds.ambiguous : 'missing on condition?'
  to_ProductUnitsOfMeasure : Association to many s4_product.A_ProductUnitsOfMeasure {  };
  @cds.ambiguous : 'missing on condition?'
  to_SalesDelivery : Association to many s4_product.A_ProductSalesDelivery {  };
  @cds.ambiguous : 'missing on condition?'
  to_Valuation : Association to many s4_product.A_ProductValuation {  };
};
...
entity s4_product.A_ProductBasicText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
...
entity s4_product.A_ProductDescription {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductInspectionText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductMLAccount {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductMLPrices {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductPlant {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
  ...
  @cds.ambiguous : 'missing on condition?'
  to_PlantMRPArea : Association to many s4_product.A_ProductPlantMRPArea {  };
  @cds.ambiguous : 'missing on condition?'
  to_PlantQualityMgmt : Association to s4_product.A_ProductPlantQualityMgmt {  };
  @cds.ambiguous : 'missing on condition?'
  to_PlantSales : Association to s4_product.A_ProductPlantSales {  };
  @cds.ambiguous : 'missing on condition?'
  to_PlantStorage : Association to s4_product.A_ProductPlantStorage {  };
  @cds.ambiguous : 'missing on condition?'
  to_PlantText : Association to s4_product.A_ProductPlantText {  };
  @cds.ambiguous : 'missing on condition?'
  to_ProdPlantInternationalTrade : Association to s4_product.A_ProductPlantIntlTrd {  };
  @cds.ambiguous : 'missing on condition?'
  to_ProductPlantCosting : Association to s4_product.A_ProductPlantCosting {  };
  @cds.ambiguous : 'missing on condition?'
  to_ProductPlantForecast : Association to s4_product.A_ProductPlantForecasting {  };
  @cds.ambiguous : 'missing on condition?'
  to_ProductPlantProcurement : Association to s4_product.A_ProductPlantProcurement {  };
  @cds.ambiguous : 'missing on condition?'
  to_ProductSupplyPlanning : Association to s4_product.A_ProductSupplyPlanning {  };
  @cds.ambiguous : 'missing on condition?'
  to_ProductWorkScheduling : Association to s4_product.A_ProductWorkScheduling {  };
  @cds.ambiguous : 'missing on condition?'
  to_StorageLocation : Association to many s4_product.A_ProductStorageLocation {  };
};
...
entity s4_product.A_ProductPlantCosting {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductPlantForecasting {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductPlantIntlTrd {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductPlantMRPArea {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductPlantProcurement {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductPlantQualityMgmt {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductPlantSales {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductPlantStorage {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductPlantText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductProcurement {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductPurchaseText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductQualityMgmt {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductSales {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductSalesDelivery {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
  ...
  @cds.ambiguous : 'missing on condition?'
  to_SalesTax : Association to many s4_product.A_ProductSalesTax {  };
  @cds.ambiguous : 'missing on condition?'
  to_SalesText : Association to many s4_product.A_ProductSalesText {  };
};
...
entity s4_product.A_ProductSalesTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductSalesText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductStorage {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductStorageLocation {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductSupplyPlanning {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductUnitsOfMeasure {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
  ...
  BaseUnit : String(3);
  @cds.ambiguous : 'missing on condition?'
  to_InternationalArticleNumber : Association to many s4_product.A_ProductUnitsOfMeasureEAN {  };
};
...
@sap.content.version : '1'
@sap.label : 'GTIN Data'
entity s4_product.A_ProductUnitsOfMeasureEAN {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductValuation {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Material'
  @sap.quickinfo : 'Material Number'
  key Product : String(40) not null;
  ...
  BaseUnit : String(3);
  @cds.ambiguous : 'missing on condition?'
  to_MLAccount : Association to many s4_product.A_ProductMLAccount {  };
  @cds.ambiguous : 'missing on condition?'
  to_MLPrices : Association to many s4_product.A_ProductMLPrices {  };
  @cds.ambiguous : 'missing on condition?'
  to_ValuationAccount : Association to s4_product.A_ProductValuationAccount {  };
  @cds.ambiguous : 'missing on condition?'
  to_ValuationCosting : Association to s4_product.A_ProductValuationCosting {  };
};
...
entity s4_product.A_ProductValuationAccount {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductValuationCosting {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
...
entity s4_product.A_ProductWorkScheduling {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Product'
  @sap.quickinfo : 'Product Number'
  key Product : String(40) not null;
